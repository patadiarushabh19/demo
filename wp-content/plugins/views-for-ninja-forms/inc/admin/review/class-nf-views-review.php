...
class NFViewsReview{
	...
	const PREFIX = 'nf_views';
	const PLUGIN_NAME = 'Views for Ninja Forms';
	const PLUGIN_REVIEW_LINK = 'https://wordpress.org/support/plugin/views-for-ninja-forms/reviews/?filter=5';
	const FILE_PATH = NF_VIEWS_URL.'/inc/admin/review';
